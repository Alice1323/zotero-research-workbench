...
If the concept you need is not in the glossary yet, either you are inventing language the project does not use or there is a real gap. Note it for `/grill-with-docs`.
